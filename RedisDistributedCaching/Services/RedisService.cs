...
namespace RedisDistributedCaching.Services
{
    public class RedisService
    {
        ...
        static public async Task<IDatabase> GetRedisMasterDatabase()
        {
            ...
            var localMasterIP = masterEndpoint.ToString() switch
            {
                ...
                "172.19.0.4:6379" => "localhost:6380",
                "172.19.0.3:6379" => "localhost:6381",
